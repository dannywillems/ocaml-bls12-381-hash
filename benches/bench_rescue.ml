...
let () = Bls12_381_hash.Rescue.constants_init Rescue_ark.v Rescue_mds.v
...
let t1 =
  ...
  Bench.Test.create ~name (fun () ->
      let ctxt = Bls12_381_hash.Rescue.init a b c in
      let () = Bls12_381_hash.Rescue.apply_permutation ctxt in
      let _v = Bls12_381_hash.Rescue.get ctxt in
      ())
