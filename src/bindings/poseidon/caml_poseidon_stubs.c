...
CAMLprim value caml_bls12_381_hash_poseidon_allocate_ctxt_stubs(
    value width, value nb_full_rounds, value nb_partial_rounds,
    value batch_size, value ark, value mds) {
...
CAMLprim value caml_bls12_381_hash_poseidon_init_stubs(value ctxt, value width,
                                                       value inputs) {
...
CAMLprim value caml_bls12_381_hash_poseidon_apply_perm_stubs(
    value ctxt, value width, value nb_full_rounds, value nb_partial_rounds,
    value batch_size) {
...
CAMLprim value caml_bls12_381_hash_poseidon_get_state_stubs(value buffer,
                                                            value ctxt,
                                                            value width) {
