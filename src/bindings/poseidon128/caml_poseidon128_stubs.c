...
CAMLprim value caml_bls12_381_hash_poseidon128_allocate_ctxt_stubs(value unit) {
  CAMLparam1(unit);
  CAMLlocal1(block);
...
CAMLprim value caml_bls12_381_hash_poseidon128_constants_init_stubs(
...
CAMLprim value caml_bls12_381_hash_poseidon128_init_stubs(value ctxt, value a,
                                                          value b, value c) {
...
CAMLprim value caml_bls12_381_hash_poseidon128_apply_perm_stubs(value ctxt) {
  CAMLparam1(ctxt);
  poseidon128_apply_perm(Poseidon128_ctxt_val(ctxt));
  CAMLreturn(Val_unit);
}

CAMLprim value caml_bls12_381_hash_poseidon128_get_state_stubs(value a, value b,
                                                               value c,
                                                               value ctxt) {
